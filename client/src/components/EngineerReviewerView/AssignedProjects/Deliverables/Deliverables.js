...
export const Deliverables = () => {
  ...
  const nextPage = () => {
    let max = Math.ceil(DeliverableMain?.reports?.length / 4);
...
<svg onClick={()=>{navigate('/view/reviewReport')}}  className='m-1'width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M8.58301 11.7917L17.7497 2.625" stroke="#007D99" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      {DeliverableMain?.reports?.length > 4 ? (
